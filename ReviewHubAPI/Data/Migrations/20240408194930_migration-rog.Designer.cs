...
namespace ReviewHubAPI.Data.Migrations
{
    ...
    [Migration("20240408194930_migration-rog")]
            ...
            modelBuilder.Entity("ReviewHubAPI.Models.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = -1,
                            DateCreated = new DateTime(2024, 4, 8, 19, 49, 29, 610, DateTimeKind.Utc).AddTicks(1036),
                            Email = "admin@proton.me",
                            Firstname = "Admin",
                            IsAdmin = true,
                            Lastname = "User",
                            PasswordHash = "$2a$11$v2szFWMd2V0HA4vUcpWmQOt9h23nxJlbYYQPllxi/6eIfvC4UM7fy",
                            Username = "TheOne"
                        });
                });
