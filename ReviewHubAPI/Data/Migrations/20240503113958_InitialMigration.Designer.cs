...
namespace ReviewHubAPI.Data.Migrations
{
    ...
    [Migration("20240503113958_InitialMigration")]
            ...
            modelBuilder.Entity("ReviewHubAPI.Models.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 5, 3, 11, 39, 58, 27, DateTimeKind.Utc).AddTicks(4194),
                            Email = "admin@proton.me",
                            Firstname = "Admin",
                            IsAdmin = true,
                            Lastname = "User",
                            PasswordHash = "$2a$11$decmuAs/dZ3FEwRoSV13d.jKqdSAwkxirJgJ3DXtc0bl6yBjp/j3e",
                            Username = "TheOne"
                        });
                });
